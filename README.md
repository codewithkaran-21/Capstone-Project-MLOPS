# ðŸ“Œ Sentiment Analysis on IMDB Reviews â€” End-to-End MLOps Project
...
- Renamed: `src/models` â†’ `src/model`
- Initial GitHub commit & push

---

## ðŸ§ª MLflow Experiment Tracking (Dagshub)
...
## â˜¸ï¸ AWS EKS Deployment (Kubernetes)
...
## ðŸ‘¤ Author  
**Karan Singh**  
AI/ML Developer â€¢ Data Scientist â€¢ MLOps Practitioner  
